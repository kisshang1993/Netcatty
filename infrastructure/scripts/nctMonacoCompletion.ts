...
const NCT_API_COMPLETIONS = [
  ...
  },
  {
    ...
    insertText: [
      ...
      "    { type: 'textarea', name: '${9:notes}', label: '${10:Notes}', required: false },",
      "    { type: 'number', name: '${11:retries}', label: '${12:Retries}', defaultValue: 3, min: 0, step: 1 },",
      '  ],',
      '});',
    ].join('\n'),
    detail: 'Form dialog',
    documentation: 'Show a form dialog with select, checkbox, radio, textarea, and number fields. Returns an object keyed by field name.',
  },
  {
